...
class LlavaMetaForCausalLM(ABC):
    ...
    def prepare_inputs_labels_for_multimodal(self, input_ids, position_ids, attention_mask, past_key_values, labels, images, image_ids, modalities=["image"], image_sizes=None):
        # return: input_ids, position_ids, attention_mask, past_key_values, new_input_embeds, new_labels, torch.stack(out_image_features)
                        ...
                        if "pad" in mm_patch_merge_type:
                            if mm_newline_position == 'one_token':
                                ...
                                if "unpad" in mm_patch_merge_type:
                                    ...
                                    print("TYPE:",mm_patch_merge_type)
        ...
        for batch_idx, cur_input_ids in enumerate(input_ids):
            cur_image_idx = image_ids[batch_idx]
            out_image_features.append(image_features[cur_image_idx])
        ...
        return None, position_ids, attention_mask, past_key_values, new_input_embeds, new_labels, torch.stack(out_image_features)
