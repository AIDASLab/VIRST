...
def load_mevis_json(image_root, json_file, dataset_name, is_train: bool = False, is_test: bool = False):
    ...
    if is_train:
        ...
        for vid in videos:  # d56a6ec78cfa, 377b1c5f365c, ...
            ...
            for exp_id, exp_dict in vid_data['expressions'].items():
                ...
                if 'revos' in dataset_name and 'TAO' in meta['video'] and 'Charades' in meta['video']:
                    # I found that TAO/Charades sometimes have invalid masks
                    # So I skip them 
                    continue 
