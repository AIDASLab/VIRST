...
# LISA
LISA_ROOT = "/t1data/users/snu-lab-d/csjihwanh/dataset/LISA"
...
# RVOS
RVOS_ROOT = "/t1data/users/snu-lab-d/csjihwanh/dataset/RVOS_ROOT"
RVOS_DATA_INFO = {
    "mevis_train"   : ("mevis/train",           "mevis/train/meta_expressions.json"),
    "mevis_valid"   : ("mevis/valid_u",         "mevis/valid_u/meta_expressions.json"),
    "mevis_test"    : ("mevis/valid",           "mevis/valid/meta_expressions.json"),
    "refytvos_train": ('refytvos/train',        'refytvos/meta_expressions/train/meta_expressions.json'),
    "refytvos_valid": ('refytvos/valid',        'refytvos/meta_expressions/valid/meta_expressions.json'),
...
VQA_VIDEO_ROOT = "/t1data/users/snu-lab-d/csjihwanh/dataset/LLaVA-Video-178K/0_30_s_academic_v0_1"