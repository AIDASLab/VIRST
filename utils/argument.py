...
class ModelArguments:
    ...
    iou_loss_weight: float = field(default=0.05)
    occ_loss_weight: float = field(default=0.05)
    bce_loss_weight: float = field(default=2.0)
    dice_loss_weight: float = field(default=0.5)

    num_seg_keyframes: int = 3

    initial_seg_fusion: bool = field(default=False)
    use_cond_frames: bool = field(default=False)
    keyframe_scheme: str = field(default="random")
    use_seg_prompter: bool = field(default=True)

    max_cond_frames_in_attn: int = field(default=3)
    max_uncond_frames_in_mem: int = field(default=7)
    
    eval_keyframe_scheme: str = field(default="uniform")
